<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageArticleClass1s.aspx.cs" Inherits="WebBeijingFire.Admin.ManageArticleClass1s" %>
...
<body>
    ...
    <div>
        ...
        <center>
            ...
            <br />
            <table width="100%" id="oTable" border="1" cellpadding="10" cellspacing="0" bordercolor="#e4ecf9"
                    ...
                    <asp:Repeater ID="ArticleRepeater" runat="server" OnItemDataBound="List_ItemDataBound">
                        <ItemTemplate>
                            <tr style="height: 35px">
                                <td>
                                    <%#DataBinder.Eval(Container.DataItem, "ArticleClass1ID")%>
                                </td>
                                <td>
                                    <a href="EditArticleClass1.aspx?ArticleClass1ID=<%#DataBinder.Eval(Container.DataItem, "ArticleClass1ID")%>"
                                        target="_blank">修改</a>
                                </td>
                                <td style="text-align: left">
                                    <%#DataBinder.Eval(Container.DataItem, "ArticleClass1Name")%>
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:LinkButton ID="LBDelete" ToolTip='<%#DataBinder.Eval(Container.DataItem,"ArticleClass1ID")%>'
