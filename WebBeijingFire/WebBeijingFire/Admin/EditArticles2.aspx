<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditArticles2.aspx.cs"  ValidateRequest="false" Inherits="WebBeijingFire.Admin.EditArticles2" %>
    ...
    <div>
        <table width="880" border="0" align="center">
            ...
            <tr>
                ...
                <td align="left">
                    &nbsp;
                    <asp:DropDownList ID="DrpArticleClass1ID" runat="server" AutoPostBack="True" 
                        onselectedindexchanged="DrpArticleClass1ID_SelectedIndexChanged">
                    </asp:DropDownList>
            ...
            <tr>
                ...
                <td align="left">
                    &nbsp;
                    <asp:DropDownList ID="DrpIsUrl" runat="server" AutoPostBack="True" 
                        onselectedindexchanged="DrpIsUrl_SelectedIndexChanged">
            ...
            <tr>
                ...
                <td align="left">
                    &nbsp;
                    <asp:Button ID="btnEdit" runat="server" OnClick="btnEdit_Click" Text="修改" Width="159px" />
                </td>
            </tr>
        </table>
    </div>
    <div style="text-align:center">
    <asp:Literal ID="LtPic" runat="server"></asp:Literal></div>
    </form>
</body>
</html>
