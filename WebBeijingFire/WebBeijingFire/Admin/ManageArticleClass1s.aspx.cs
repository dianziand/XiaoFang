...
{
    public partial class ManageArticleClass1s : System.Web.UI.Page
    {
        private int page = 1;
        ...
        string url = "ManageArticleClass1s.aspx";
        ...
        protected void LBDelete_Command(object sender, CommandEventArgs e)
        {
            ...
            WebClass.DeleteArticleClass1sEntity(id);
        ...
        void bindInfoListData(int _page)
        {
            ...
            {
                strWhere.Append(" and ArticleClass1Name like '%").Append(Key).Append("%' ");
            }

            ArticleRepeater.DataSource = WebClass.GetResultSP_Page2000(" ArticleClass1s act ", "* ", PageSize, page, out TotalPage, out totalRecord, "ArticleClass1ID", 0, strWhere.ToString(), "ArticleClass1ID", 0);
