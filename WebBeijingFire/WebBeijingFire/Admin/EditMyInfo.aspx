<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditMyInfo.aspx.cs" Inherits="WebBeijingFire.Admin.EditMyInfo" %>
        ...
        <table width="700" border="0" align="center">
            ...
            <tr>
                ...
                <td width="455" align="left">
                    &nbsp;
                    <asp:TextBox ID="txtAdminName" runat="server" Width="144px" Enabled="False"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
            ...
            <tr>
                ...
                <td align="left">
                    &nbsp;
                    <asp:DropDownList ID="drpAdminGroupID" runat="server" Enabled="False">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td align="left">
                    &nbsp;
                    <asp:DropDownList ID="drpActive" runat="server" Enabled="False">
