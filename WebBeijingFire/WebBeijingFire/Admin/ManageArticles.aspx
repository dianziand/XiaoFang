<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageArticles.aspx.cs" Inherits="WebBeijingFire.Admin.ManageArticles" %>
    ...
    <div>
        <table width="700" border="0" align="center">
            ...
            <tr>
                ...
                <td width="455" align="left">
                    &nbsp;
                    <asp:TextBox ID="TxtArticleID" runat="server" Width="273px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
                    ...
                    <asp:Repeater ID="ArticleRepeater" runat="server"  OnItemDataBound="List_ItemDataBound">
                        <ItemTemplate>
                            <tr style="height:35px">
                                ...
                                <td>
                                    <a href="EditArticles.aspx?ArticleID=<%#DataBinder.Eval(Container.DataItem, "ArticleID")%>"
                                        target="_blank">修改</a>
                                </td>
                                <td style=" text-align: left"><a href="<%#DataBinder.Eval(Container.DataItem, "Url")%>"
                                        target="_blank"><%#DataBinder.Eval(Container.DataItem, "Title")%></a><font color="#999999">(<%#DataBinder.Eval(Container.DataItem, "AddDate")%>)</font><%#DataBinder.Eval(Container.DataItem, "IsUrl").ToString()=="1" ? "<font color=blue><b>链</b></font>" : ""%>
                                        
                                </td>
                                <td >
                                        <%#DataBinder.Eval(Container.DataItem, "ArticleClass1Name")%><br />                                        
                                ...
                                <td>
                                    <asp:LinkButton ID="LBDelete" ToolTip='<%#DataBinder.Eval(Container.DataItem,"ArticleID")%>'
